% This is Eva's comment and Dan's comment.
...
~\hspace{-20pt}\includegraphics[width=340pt]{images/wrong_dir.png}
\end{frame}
...
\only<1>{
~\hspace{-15pt}\includegraphics[width=340pt]{images/no_pycryptosat.png}
}
\only<2>{
~\hspace{-15pt}\includegraphics[width=340pt]{images/symbol.png}
}
\end{frame}
...
\only<1>{\vspace{24pt}\centerline{\includegraphics[width=270pt]{images/git_boxes.pdf} }}%
\only<2>{\centerline{\includegraphics[width=270pt]{images/git_boxes2.pdf} }}%
\only<3>{\vspace{22pt}\centerline{\includegraphics[width=300pt]{images/git_boxes4.pdf} }}%

\end{frame}

\begin{frame}[fragile] {Git: workflow with local and remote}
\only<1>{\centerline{\includegraphics[width=330pt]{images/github2.pdf}}}
\only<2->{\centerline{\includegraphics[width=330pt]{images/github3.pdf}}}
\only<3->{
\vspace{-5pt}
...
\centerline{\includegraphics[width=330pt]{images/pull.pdf}}
\end{frame}

\begin{frame} [fragile] {Moral of the story: {\tt git pull} and then {\tt git push}}
\vspace{20pt}
\only<1>{\vspace{-140pt}\centerline{\hspace{-20pt}\includegraphics[width=310pt]{images/pull2.pdf}}}
\only<2->{\centerline{\includegraphics[width=330pt]{images/pull3.pdf}}}
\uncover<3>{
\vspace{-20pt}
{\bf Workflow recap:}
\vspace{-15pt}
...
\centerline{\includegraphics[width=200pt]{images/uncommitted_conflict.pdf} }

\pause
\vspace{40pt}

\centerline{\includegraphics[width=250pt]{images/uncommitted_error.png} }
\end{frame}

\begin{frame}[fragile] {Branches}
\only<1>{\vspace{-290pt}\centerline{\hspace{-40pt}\includegraphics[width=160pt]{images/branches1.pdf}}}
\only<2>{\vspace{-190pt}\centerline{\includegraphics[width=300pt]{images/branches2.pdf}}}
\only<3>{\vspace{-100pt}\centerline{\includegraphics[width=290pt]{images/branches3.pdf}}}
\only<4->{\vspace{-50pt}\centerline{\includegraphics[width=310pt]{images/branches4.pdf}}}
\only<5>{
...
\hspace{-20pt}\includegraphics[width=120pt]{images/vscode1.png}
\hspace{50pt}
...
\hspace{-20pt}\includegraphics[width=120pt]{images/vscode3.png}
\vspace{-40pt}
\end{frame}
